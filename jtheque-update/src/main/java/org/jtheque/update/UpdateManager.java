...
public final class UpdateManager implements IUpdateManager {
    ...
    public UpdateManager() {
        ...
        state = UpdateServices.get(IStateManager.class).getOrCreateState(UpdatableState.class);
    ...
    private boolean isAModuleNotUpToDate() {
        ...
        for (Module module : UpdateServices.get(IModuleManager.class).getModules()) {
