 ...
 */
public final class ModuleManager implements IModuleManager, BundleContextAware {
    ...
    public void unplugModules() {
        ...
        for (ModuleContainer module : modulesToUnplug) {
            ...
            getService(ILanguageManager.class).removeBaseName(module.getI18n());
        }
    }
    ...
    private void configureModules() {
        configuration = getService(IStateManager.class).getOrCreateState(ModuleConfiguration.class);
    ...
    private String getMessage(String key, String... replaces) {
        return getService(ILanguageManager.class).getMessage(key, replaces);
    }
